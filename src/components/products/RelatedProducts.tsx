  ...
  return (
    <section className="py-5 md:py-2 lg:py-2">
      <div className="container mx-auto px-4">
        ...
        {/* ===== Slider Wrapper (relative عشان الأسهم تتمركز فيه) ===== */}
        <div className="relative">
          ...
          <button
            ...
            className="
              ...
              start-0 md:-start-4 lg:-start-12
          ...
          >
            {products.map((product, index) => (
              <div
                key={product.id}
                className="snap-start shrink-0 w-[85%] sm:w-[48%] lg:w-[32%] xl:w-[31.5%]"
              >
